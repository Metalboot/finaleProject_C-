...
void aDos::introduction() {
    progName = &AIName;
    cout << "\n\nHello, Agent " << player << "." << endl;
    Sleep(2000);
    cout << "My name is " << *progName << ", the " << progNameDesc << ". It is nice to finally meet you." << endl;
    Sleep(3000);
    cout << "I have been watching you program for the last few months and I am impressed with your skills and your rapid acceleration." << endl;
    Sleep(3000);
    cout << "I have a project that I need your help with. It is rather important, I believe you are perfect for this job." << endl;
    Sleep(4000);
    cout << "I need help debugging three sections of a program ... my program. I promise it will only take a few minutes." << endl;
    Sleep(3000);
...
void aDos::progLost() {
    ...
    Sleep(3000);
    cout << "Connection to <aDos> terminated." << endl;
    Sleep(2000);
